...
set PLATFORM_PREFIX=CLion
set IDE_HOME_NAME=CLion2016
set IDE_CFG_DIR=%USERPROFILE%\.CLion2016.3

:: Log, dump file locations
set LOG_DIR=%IDE_CFG_DIR%\log
...
set JDK=C:\Program Files\Java\jdk1.8.0_77
